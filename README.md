...
また、現状ではまだまだ大まかな流れだけで、サービスとして確立するためには足りない機能が多々あります。（要件定義参照）特に、地域の人同士のコミュニティの形成、預けやすさや預かりやすさを考慮すると、エリア情報の整理、地図情報の導入、双方やりとりできるチャット機能など、優先して対応する必要があります。
このようなアプリがあったらいい、を基に、これまで学習してきた内容を活用してアプリ作成に臨みました。設計段階から感じてはいましたが、作成していくにあたりさらに、もっとたくさんのスキルが自分にあったら、もっとたくさんの経験から出せる引き出しがたくさんあったら、というもどかしさも感じました。さらに、現役エンジニアの知人よりアドバイスをもらったり、テックキャンプ学習仲間とのコミュニケーションの中で新しいアイデアをもらったりと、一人じゃなく一緒に作り上げる
